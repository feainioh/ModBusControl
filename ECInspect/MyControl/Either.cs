...
namespace ECInspect
{
    public partial class Either : UserControl
    {
        ...
        public delegate void dele_LeftRight(object sender, LeftRightSide lr);
        /// <summary>
        /// 按键
        /// </summary>
        ...
        private void btn_left_Click(object sender, EventArgs e)
        {
            ...
            if (Event_BtnClick != null) Event_BtnClick(this, LeftRightSide.Left);
        }
        ...
        private void btn_right_Click(object sender, EventArgs e)
        {
            ...
            if (Event_BtnClick != null) Event_BtnClick(this, LeftRightSide.Right);
        }
        ...
        public void ChangeBackColor(bool left)
        {
            if (left)
            {
