...
namespace ECInspect
{
    ...
    public partial class AxisY : AxisInterface
    {
        ...
        private void UpdateValue()
        {
            ...
            double AxisYScanPoint = GlobalVar.c_Modbus.HoldingRegisters.AxisY_ScanPoint.Value;
            AxisYScanPoint /= GlobalVar.ConverRate;
            ...
            this.textBox_YAxisPhotoCenterPosition.Text = GlobalVar.gl_origin_Y.ToString("#0.00");//YAxisPhotoCenterPosition.ToString("#0.00");
            this.textBox_AxisYScanPoint.Text = AxisYScanPoint.ToString("#0.00");
        }
        ...
        private void textBox_AxisYScanPoint_Click(object sender, EventArgs e)
        {
            //修改Y轴扫码位置[2018.3.28 lqz]
            ChangePLCValue(sender, GlobalVar.c_Modbus.HoldingRegisters.AxisY_ScanPoint, 2, this.axisTrackBar.AxisMaxValue / GlobalVar.ConverRate, this.axisTrackBar.AxisMinValue / GlobalVar.ConverRate);
        }
        private void textBox_YAxisPhotoCenterPosition_Click(object sender, EventArgs e)
        {
            ...
            if (TextClick(sender, ref d, 2, (double)INIFileValue.YAxisRange.MAX, (double)INIFileValue.YAxisRange.MIN))
            {
                ...
                myFunction.WriteIniString(INIFileValue.gl_inisection_CCDOrigin, INIFileValue.gl_iniKey_CCDOrigin_Y, d.ToString());
                GlobalVar.gl_origin_Y = d;
            }
        }
