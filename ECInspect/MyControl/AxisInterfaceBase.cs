        ...
        private void AxisHOME()
        {
            ...
            switch (m_AxisName)
            {
                ...
                case Axis.Carry:
                    ...
                    break;
                case Axis.CCD:
                    home = GlobalVar.c_Modbus.Coils.CCD_Home;
                    break;
                default:
                    return;
            }
        ...
        private void UpdateValue()
        {
            ...
            switch (m_AxisName)
            {
                ...
                case Axis.Peel:
                    ...
                    break;
                case Axis.CCD:
                    RealLocation = GlobalVar.c_Modbus.HoldingRegisters.CCD_RealLocation.Value;//实际位置
                    MoveSpeed = GlobalVar.c_Modbus.HoldingRegisters.CCD_MoveSpeed.Value;//定位速度
                    MoveOriginSpeed = GlobalVar.c_Modbus.HoldingRegisters.CCD_MoveOriginSpeed.Value;//归原点速度
                    MoveOriginCrawSpeed = GlobalVar.c_Modbus.HoldingRegisters.CCD_MoveOriginCrawlSpeed.Value;//归原点爬行速度
                    JOGSpeed = GlobalVar.c_Modbus.HoldingRegisters.CCD_JogSpeed.Value;//JOG速度
                    AcceleratSpeed = GlobalVar.c_Modbus.HoldingRegisters.CCD_AccelerateSpeed.Value;//加速度
                    DeceleratSpeed = GlobalVar.c_Modbus.HoldingRegisters.CCD_DecelerateSpeed.Value;//减速度
                    break;
                default:
                    return;
            }
            ...
            else if (m_AxisName == Axis.CCD)
            {
                RealLocation *= GlobalVar.ConverRate_CCD;//实际位置
                MoveSpeed *= GlobalVar.ConverRate_CCD;//定位速度
                MoveOriginSpeed *= GlobalVar.ConverRate_CCD;//归原点速度
                MoveOriginCrawSpeed *= GlobalVar.ConverRate_CCD;//归原点爬行速度
                JOGSpeed *= GlobalVar.ConverRate_CCD;//JOG速度
            }
            else
            {
        ...
        private void AxisJOG(bool Positive, bool Run)
        {
            ...
            switch (m_AxisName)
            {
                ...
                case Axis.Carry:
                    ...
                    break;
                case Axis.CCD:
                    JOGCoil = new Coil[2] { GlobalVar.c_Modbus.Coils.CCD_Positive,GlobalVar.c_Modbus.Coils.CCD_Negative};
                    break;
                default:
                    return;
            }
        ...
        private void textBox_MoveSpeed_Click(object sender, EventArgs e)
        {
            switch (m_AxisName)
            {
                ...
                case Axis.Peel:
                    ...
                    break;
                case Axis.CCD:
                    ChangePLCValue(sender,GlobalVar.c_Modbus.HoldingRegisters.CCD_MoveSpeed,2);
                    break;
                default:
                    return;
            }
        ...
        private void textBox_MoveOriginSpeed_Click(object sender, EventArgs e)
        {
            switch (m_AxisName)
            {
                ...
                case Axis.Carry:
                    ...
                    break;
                case Axis.CCD:
                    ChangePLCValue(sender,GlobalVar.c_Modbus.HoldingRegisters.CCD_MoveOriginSpeed,2);
                    break;
                default:
                    return;
            }            
        ...
        private void textBox_MoveOriginCrawlSpeed_Click(object sender, EventArgs e)
        {
            switch (m_AxisName)
            {
                ...
                case Axis.Carry:
                    ...
                    break;
                case Axis.CCD:
                    ChangePLCValue(sender,GlobalVar.c_Modbus.HoldingRegisters.CCD_MoveOriginCrawlSpeed,2,50,0);
                    break;
                default:
                    return;
            }
        ...
        private void textBox_JOGSpeed_Click(object sender, EventArgs e)
        {
            switch (m_AxisName)
            {
                ...
                case Axis.Carry:
                    ...
                    break;
                case Axis.CCD:
                    ChangePLCValue(sender,GlobalVar.c_Modbus.HoldingRegisters.CCD_JogSpeed,2);
                    break;
                default:
                    return;
            }
        ...
        private void textBox_AcceleratSpeed_Click(object sender, EventArgs e)
        {
            switch (m_AxisName)
            {
                ...
                case Axis.Carry:
                    ...
                    break;
                case Axis.CCD:
                    ChangePLCValue(sender, GlobalVar.c_Modbus.HoldingRegisters.CCD_AccelerateSpeed);
                    break;
                default:
                    return;
            }
        ...
        private void textBox_DeceleratSpeed_Click(object sender, EventArgs e)
        {
            switch (m_AxisName)
            {
                ...
                case Axis.Carry:
                    ...
                    break;
                case Axis.CCD:
                    ChangePLCValue(sender, GlobalVar.c_Modbus.HoldingRegisters.CCD_DecelerateSpeed);
                    break;
                default:
                    return;
            }
